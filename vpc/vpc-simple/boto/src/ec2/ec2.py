...
class EC2:
    ...
    def create_key_pair(self, key_name):
        print(f'- Creating a keypair with name {key_name}...')
        return self._client.create_key_pair(KeyName=key_name)
    
    def create_security_group(self, group_name, description, vpc_id):
        print(f'- Creating a Security Group with name: {group_name} for VPC {vpc_id}')
    ...
    def add_inbound_rule_to_sg(self, sg_group_id):
        print(
            f'Adding inbound public access to Security Group {sg_group_id}')
